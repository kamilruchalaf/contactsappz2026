...
- Ikony pobieraj z Material Icons (`androidx.compose.material.icons.*`) dostepnych w projekcie. Wlasne ikony rysowane recznie, wektorowe assety albo bitmapy stosuj dopiero wtedy, gdy Material Icons nie zawiera odpowiedniego symbolu lub projekt ma dedykowany zestaw ikon.
